...
This is an R Markdown document with Shiny app. You can use this app to capture historical demand from a CSV file, browsing the desired sku, checking the results and then export the estimated demand to an Excel file.
:::
